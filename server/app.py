...
from avatar_pipeline.model6_body3d.face_customization import apply_face_customization
from avatar_pipeline.model6_body3d.garment_mesh import build_garment_glb, get_garment, list_garments
from avatar_pipeline.model6_body3d.garment_texture_paint import (
    CATEGORY_V_BAND, paint_garment_onto_texture,
)
from avatar_pipeline.model6_body3d.makehuman_mesh import (
    TEXTURE_SIZE, extract_base_color_texture, repaint_avatar_texture,
)
from avatar_pipeline.model7_garment_fitting import (
    GARMENT_PIPELINE_MODE, PIPELINE_MODES, GarmentFittingError, run_garment_fitting,
)
from avatar_pipeline.model7_garment_fitting.multiview.pipeline import (
    run_multiview_tryon_fitting, run_multiview_tryon_fitting_top_and_bottom,
)
from server import garment_fit_storage, storage, users
from server.ai_tryon import ai_session_storage, gemini_client, image_to_3d
from server.ai_tryon.gemini_client import generate_tryon_image
from server.ai_tryon.image_to_3d import get_provider
...
if MOCK:
    from server.mock_pipeline import build_avatar as _build_avatar

    def build_avatar(photo, bust, waist, hips, height):
        return _build_avatar(photo, bust, waist, hips, height)
else:
    from avatar_pipeline.controller import build_avatar as _build_avatar, load_pipeline_models
...
def _get_body_shape_artifacts():
    ...
    if _body_shape_artifacts is None:
        from avatar_pipeline.model1_body_shape.predict import load_artifacts
...
def predict_body_shape_route():
    ...
    """
    from avatar_pipeline.model1_body_shape.predict import predict_body_shape
...
def _resolve_catalog_garment_png(garment_id: str) -> bytes | None:
    ...
    asset_path = REPO_ROOT / "mobile" / "assets" / "clothing" / f"{garment_id}.png"
