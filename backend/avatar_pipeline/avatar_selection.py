...
scripts/bake_makehuman_morphs.py), copied to mobile_app/assets/avatars/ as flat
...
def select_avatar(gender, body_shape, bust, waist, hips, height, assets_dir="mobile_app/assets"):
    ...
    assets_dir: defaults to the actual app asset root (mobile_app/assets), where
