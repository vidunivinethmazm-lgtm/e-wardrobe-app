...
from backend.avatar_pipeline.model4_avatar.condition_utils import body_shape_to_onehot, keypoints_to_pose_vector
...
if __name__ == "__main__":
    ...
    from backend.avatar_pipeline.model4_avatar.synthetic_avatars import CANONICAL_POSE
