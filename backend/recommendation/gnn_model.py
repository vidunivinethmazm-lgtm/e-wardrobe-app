...
# Resolve data / weight files relative to this module, not the CWD.
...
def build_edges_from_data(wardrobe, csv_path=None):
    df = pd.read_csv(csv_path or HERE / 'wardrobe_data.csv')
...
def train_model():
    ...
    torch.save(model.state_dict(), HERE / 'gnn_model.pth')
